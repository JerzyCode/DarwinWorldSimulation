...
class FireEarthTest {
    ...
    void placePlantShouldSucceed() {
        ...
        var fireEarth = new FireEarth(1, 1, 1, 10, 5, 0, PlantVariant.FORESTED_EQUATORS);
    ...
    void placeFireShouldSucceed() {
        //given
        var fireEarth = new FireEarth(10, 10, 2, 5, 5, 0, PlantVariant.FORESTED_EQUATORS);
    ...
    void handleDayEndsShouldCreateNewFire() {
        // given
        var fireEarth = new FireEarth(10, 10, 1, 10, 0, 0, PlantVariant.FORESTED_EQUATORS);
