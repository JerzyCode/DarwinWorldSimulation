...
class AnimalMovementIntegrationTest {
  ...
  void shouldChangeAnimalsOrientationToNorth() {
    ...
    var animals = List.of(new Animal(new Vector2d(2, 2)), new Animal(new Vector2d(0, 0)));
  ...
  void shouldChangeAnimalsOrientationToEast() {
    ...
    var animals = List.of(new Animal(new Vector2d(4, 4)), new Animal(new Vector2d(0, 0)));
    var moveDirections = OptionsParser.parse(args);
  ...
  void shouldNotChangeXWhenTryingMoveOutsideMap() {
    ...
    var animals = List.of(new Animal(new Vector2d(0, 0)), new Animal(new Vector2d(4, 4)));
    var moveDirections = OptionsParser.parse(args);
  ...
  void shouldDecreaseAnimalsX() {
    ...
    var animals = List.of(new Animal(new Vector2d(2, 2)), new Animal(new Vector2d(2, 3)));
    var moveDirections = OptionsParser.parse(args);
  ...
  void shouldNotCreateAnimalAtTheSamePosition() {
    ...
    //then
    Assertions.assertEquals(1, simulation.getObjects().size());
  ...
  void shouldNotMoveWhenTryToMoveAtOccupied() {
    ...
    var moveDirections = OptionsParser.parse(args);
    var animals = List.of(new Animal(new Vector2d(2, 3)), new Animal(new Vector2d(2, 2)));
